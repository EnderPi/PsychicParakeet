...
namespace EnderPi.Framework.Random
{
    public static class RandomHelper
    {
        ...
        /// <summary>
        /// Runs the byes of the given ulong through the rindjael S-box.
        /// </summary>
        /// <param name="x"></param>
        /// <returns></returns>
        public static ulong Rindjael(ulong x)
        {
        ...
        /// <summary>
        /// Rindjael's S-box lookup table.  Provides nonlinearity in cipher.
        /// </summary>
        private readonly static byte[] _SBox =
            {
