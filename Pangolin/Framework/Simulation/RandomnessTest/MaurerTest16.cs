...
{
    public class MaurerTest16 : IIncremental16RandomTest
    {
        ...
        {
            UInt64 difference = _iterationsPerformed - _indices[randomNumber];
            _indices[randomNumber] = _iterationsPerformed;
            if (_isInitialized)
            {
