...
namespace GeneticWeb.Pages
{
    ...
    /// </summary>
    public partial class GeneticFeistel32
    {
        /// <summary>
        ...
        /// </summary>
        private RngSpecies32Feistel _bestSpecies;

        /// <summary>
        /// Current random species being displayed.
        /// </summary>
        private RngSpecies32Feistel _randomSpecies;
        ...
        private List<List<RngSpecies32Feistel>> _allSpecimens;
        ...
        protected override void OnInitialized()
        {
            ...
            AssignSpecies(new RngSpecies32Feistel());
            ...
            _model.FeistelRounds = 4;
            _model.Iterations = 1;
        }

        public GeneticFeistel32()
        {
        ...
        {
            _allSpecimens = new List<List<RngSpecies32Feistel>>();
            AssignSpecies(null);
            _randomSpecies = null;
        ...
        public void BackgroundTaskDelegate()
        {
            ...
            GeneticRngBreedingFeistel geneticTask = null;
            try
            {
                ...
                geneticTask = new GeneticRngBreedingFeistel(parameters);
        ...
        public void AssignSpecies(RngSpecies32Feistel species)
        {
            if (species != null)
            {
        ...
        private void UpdateGeneration(object sender, GeneticFeistelEventArgs e)
        {
            try
            {
